 ...
 */
final class Version20210404050046 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contributor (id INT AUTO_INCREMENT NOT NULL, github_id VARCHAR(255) NOT NULL, login VARCHAR(255) NOT NULL, avatar_url VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE organization (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, name VARCHAR(100) NOT NULL, website VARCHAR(50) DEFAULT NULL, description VARCHAR(1000) DEFAULT NULL, organization_logo VARCHAR(255) DEFAULT NULL, INDEX IDX_C1EE637C7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, domain_expertise_id INT NOT NULL, technical_expertise_id INT NOT NULL, owner_id INT NOT NULL, organization_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, objective VARCHAR(255) NOT NULL, description VARCHAR(1000) NOT NULL, website VARCHAR(50) DEFAULT NULL, bug_tracking VARCHAR(255) DEFAULT NULL, documentation VARCHAR(255) DEFAULT NULL, project_data_file VARCHAR(255) DEFAULT NULL, project_logo VARCHAR(255) DEFAULT NULL, INDEX IDX_2FB3D0EE454E474 (domain_expertise_id), INDEX IDX_2FB3D0EE7A810A65 (technical_expertise_id), INDEX IDX_2FB3D0EE7E3C61F9 (owner_id), INDEX IDX_2FB3D0EE32C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
